...
client.query('CREATE TABLE users (id SERIAL PRIMARY KEY, lobby integer REFERENCES(lobbies), username varchar(64) UNIQUE, email varchar(255) UNIQUE, password varchar(255), registration_opt_in boolean DEFAULT false)');
